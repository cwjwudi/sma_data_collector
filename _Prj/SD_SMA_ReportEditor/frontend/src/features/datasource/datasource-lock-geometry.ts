/** 数据源滑动锁：轨道 / 拇指 / 进度条几何（纯函数，供组件与单测共用） */

export const LOCK_TRACK_W = 88
export const LOCK_TRACK_H = 32
export const LOCK_THUMB = 24
...
/**
 * 指针位置 → 进度 %。按拇指中心可走区间映射，使拖柄中心与指针重合时 pct 一致。
 */
